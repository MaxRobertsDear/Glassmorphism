...
import CardA from "./components/ComponentA";
import CardB from "./components/ComponentB";
import CardC from "./components/ComponentC";
import CardD from "./components/ComponentD";
import CardE from "./components/ComponentE";
import {
  layout,
  yCoordCardB,
  BASE_CARD_HEIGHT,
...
export const Example = () => {
  ...
  const scrollHandler = useAnimatedScrollHandler((e, ctx) => {
    reanimatedY.value = e.contentOffset.y;
  });
